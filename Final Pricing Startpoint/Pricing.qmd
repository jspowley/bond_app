...
cf_dates <- cf_dates %>% 
  mutate(cf = if_else(date == MaturityDate, FaceValue + ((CoupRate / 100) / 2) * FaceValue , CoupRate / 2),
...
portfolio_value <- price_portfolio(my_bonds, today = "2025-02-08", boot)
